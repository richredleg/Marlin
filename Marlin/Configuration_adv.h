...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #if HAS_BED_PROBE
    #define PROBE_OFFSET_WIZARD			//R3DL3GNL
...
#define BABYSTEPPING	//R3DL3GNL
  ...
  #define BABYSTEP_ZPROBE_OFFSET          	//R3DL3GNL	// Combine M851 Z and Babystepping
 ...
 */
#define ADVANCED_PAUSE_FEATURE	//R3DL3GNL
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       964      //R3DL3GNL // (mA) RMS current. Multiply by 1.414 for peak current.
    #define X_CURRENT_HOME  X_CURRENT  // (mA) RMS current for sensorless homing
    #define X_MICROSTEPS     16        // 0..256
    #define X_RSENSE          0.075	//R3DL3GNL
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V	//R3DL3GNL
   ...
   */
  #define MONITOR_DRIVER_STATUS	//R3DL3GNL
   ...
   */
  #define SQUARE_WAVE_STEPPING	//R3DL3GNL

  /**
   * Enable M122 debugging command for TMC stepper drivers.
   * M122 S0/1 will enable continous reporting.
   */
  #define TMC_DEBUG				//R3DL3GNL
